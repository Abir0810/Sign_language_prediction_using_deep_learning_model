# -*- coding: utf-8 -*-
"""un_balance_cnn (1).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1a3RD3rI2Fl-04f5KxTVyqlP4iB7-wtVP
"""
...
sns.set_theme()
plt.plot(bcnn.history['accuracy'], '',color="blue")
plt.plot(bcnn.history['val_accuracy'] ,'', color="magenta")
...
plt.figure(figsize=[8, 4])
sns.set_theme()
plt.plot(bcnn.history['loss'],'', color="blue")
plt.plot(bcnn.history['val_loss'],'', color="magenta")
